...
def main() -> None:
    ...
    forbid(r"case\s+\.universe:\s*\n\s*PlaceholderRootTabView", source, "Universe root tab must be a functional discovery screen, not a placeholder.")
    ...
    forbid(r"case\s+\.my:\s*\n\s*PlaceholderRootTabView", source, "My root tab must be a functional local library screen, not a placeholder.")
